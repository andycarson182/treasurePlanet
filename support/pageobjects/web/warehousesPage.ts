...
class WarehousesPage {
    ...
    public get warehouseStateDropdown() {
        return this.browser.$('[data-testid=state-dropdown-input]');//we need to adjust the attribute name
    }

    public get warehouseStateField() {
        return this.browser.$('#state');//we need to adjust the attribute name
    }
